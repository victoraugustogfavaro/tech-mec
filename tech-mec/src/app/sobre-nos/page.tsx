    ...
    <section>
      ...
      <div className={"w-[70%] my-[4%] mx-auto"}>
        ...
        <p className={"mt-[14px] text-[1.2rem]"}>
          ...
          <span className={"font-bold"}>parceria com a Porto</span>, uma empresa
          líder no mercado de seguros e serviços financeiros. Foi fundada em
          2024 e tem sido pioneira em oferecer soluções de qualidade para seus
          clientes.
        </p>
        <p className={"mt-[14px] text-[1.2rem]"}>
          ...
          Acreditamos que a<span className={"font-bold"}> tecnologia</span> pode
          transformar a maneira como os serviços são prestados, tornando-os mais{" "}
          <span className={"font-bold"}>rápidos</span>,{" "}
        ...
        <p className={"mt-[14px] text-[1.2rem]"}>
          ...
          <span className={"font-bold"}>serviço excepcional</span> e superar as
        ...
        <p className={"mt-[14px] text-[1.2rem]"}>
          ...
          <span className={"font-bold"}>futuro dos serviços automotivos!</span>
        </p>
      </div>
    </section>
  );
